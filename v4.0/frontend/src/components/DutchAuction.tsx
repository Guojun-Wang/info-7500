...
export function DutchAuction(): ReactElement {
  ...
  const [reservePriceInput, setReservePriceInput] = useState<number>(DEFAULT_NUMBER_VAL);
  const [offerPriceDecrementInput, setOfferPriceDecrementInput] = useState<number>(DEFAULT_NUMBER_VAL);
  const [numBlocksAuctionOpenInput, setNumBlocksAuctionOpenInput] = useState<number>(DEFAULT_NUMBER_VAL);
